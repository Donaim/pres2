...
<div class="panel px-6 py-6">
  ...
  <div class="text-2xl leading-tight mt-5">
    Система щодень придумує нові способи як <b>принизити</b> людину виміруваням.
  </div>
</div>
---
...
<div class="grid grid-cols-3 gap-6 pt-2 items-stretch" style="height:calc(100% - 0.5rem);">
  ...
  <div class="panel px-6 py-6 flex flex-col justify-between" style="min-height:0;">
    ...
    <div class="mt-6 text-xl leading-tight">
      Коли людина стає <b>своїм же інспектором</b>, система може віддихати.
    </div>
  </div>
</div>
---
...
<div class="grid grid-cols-6 gap-6 pt-2 items-stretch">
  <div class="col-span-4 panel px-6 py-6">
